...
final class Version20260614000001 extends AbstractMigration
{
    ...
    {
        return 'Add remark column to device_lease';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE device_lease ADD COLUMN remark CLOB DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // SQLite does not support DROP COLUMN; recreate the table without remark
        ...
        $this->addSql('INSERT INTO device_lease_tmp SELECT id, network_id, mac_address, ip_address, hostname, ip_type, lease_expires_at, seen_at, last_updated_at FROM device_lease');
